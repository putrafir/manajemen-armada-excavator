    ...
    <div className="min-h-[85vh] flex items-center justify-center p-4 font-sans">
      <div className="bg-white rounded-2xl border border-slate-200/90 shadow-xl max-w-md w-full p-8 space-y-6 text-center">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="text-[10px] tracking-widest text-slate-400 uppercase font-semibold font-mono">
        ...
        {/* Submit Button */}
        <Link href="/">
          <button className="w-full py-3 bg-[#E65100] hover:bg-[#D84315] text-white font-bold text-sm rounded-xl shadow-md shadow-orange-950/20 transition cursor-pointer font-mono flex items-center justify-center gap-2 mt-2">
            Sign In &rarr;
          </button>
        </Link>

        {/* Security Badges */}
        <div className="border-t border-slate-100 pt-4 flex items-center justify-center gap-6 text-[10px] font-mono text-slate-400">
