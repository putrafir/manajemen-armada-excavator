...
export default function RegistryPage() {
  ...
  const fleetAssets = [
    { id: "EX-04", model: "CAT 6040 FS", vin: "CAT-902-AU-64", node: "EDGE-TC-8829-PX", mac: "00:1A:2B:3C:4D:5E", site: "Sector 4 - North Pit", status: "ACTIVE", tier: "Tier 4F" },
    { id: "EX-12", model: "Komatsu PC4000-11", vin: "110-KM-PC40", node: "EDGE-TC-9024-KM", mac: "00:25:96:FF:FE:12", site: "Bench 09A - Upper Sill", status: "ACTIVE", tier: "Tier 4F" },
    { id: "EX-19", model: "Hitachi EX3600-6", vin: "HT-3600-084", node: "EDGE-TC-4402-HT", mac: "00:1B:44:02:89:94", site: "Sector 2 - West Wall", status: "ACTIVE", tier: "Tier 4" },
    { id: "EX-27", model: "Liebherr R 9800 G6", vin: "LH-9800-41", node: "EDGE-TC-3312-LH", mac: "00:1B:44:33:12:AA", site: "Sector 4 - North Pit", status: "ACTIVE", tier: "Tier 4F" },
    { id: "EX-08", model: "Hitachi EX5600-7", vin: "HT-5600-22", node: "EDGE-TC-7711-HT", mac: "00:1B:44:77:11:08", site: "Bench 12 - Overburden", status: "STANDBY", tier: "Tier 4F" },
  ];
    ...
    <div className="space-y-6 max-w-[1560px] mx-auto font-sans">
      ...
      <div className="bg-white rounded-xl border border-slate-200/80 p-6 shadow-xs flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button 
          ...
          className="flex items-center gap-2 px-4 py-2.5 bg-[#E65100] hover:bg-[#D84315] text-white font-bold text-xs rounded-lg shadow-sm transition cursor-pointer font-mono shrink-0"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div className="bg-white rounded-xl border border-slate-200/80 p-5 shadow-xs flex items-center justify-between font-mono">
          <div>
            <div className="text-[11px] text-slate-400 uppercase font-bold">TOTAL PROVISIONED ASSETS</div>
            <div className="text-3xl font-black text-slate-900 my-1">52 <span className="text-sm text-slate-500 font-normal">Units</span></div>
        ...
        <div className="bg-white rounded-xl border border-slate-200/80 p-5 shadow-xs flex items-center justify-between font-mono">
          <div>
            ...
            <div className="text-3xl font-black text-slate-900 my-1">50 / 52 <span className="text-sm text-slate-500 font-normal">Bound</span></div>
      ...
      <div className="bg-white rounded-xl border border-slate-200/80 shadow-xs overflow-hidden">
        <div className="p-4 border-b border-slate-200/80 flex flex-col md:flex-row md:items-center justify-between gap-4 font-mono text-xs">
          ...
          <div className="flex items-center gap-2">
            ...
            <select className="bg-slate-50 border border-slate-200 px-3 py-1.5 rounded-md font-semibold text-slate-700">
              <option>All Classes (CAT, Komatsu, Hitachi, Liebherr)</option>
            </select>
          </div>
        </div>
              ...
              {fleetAssets.map((asset) => (
                <tr key={asset.id} className="hover:bg-slate-50 transition">
                  ...
                  <td className="py-4 px-6 font-sans">
                    ...
                    <div className="text-[11px] text-slate-400 font-mono">VIN: {asset.vin}</div>
                  </td>
        ...
        <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-xs flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl border border-slate-200 shadow-2xl max-w-xl w-full p-6 space-y-5 animate-in fade-in zoom-in-95 duration-150">
            <div className="flex items-center justify-between border-b border-slate-100 pb-4">
              <div>
                <div className="text-xs font-mono font-bold uppercase tracking-wider text-orange-600 flex items-center gap-1.5">
            ...
            <div className="space-y-4 font-mono text-xs">
              ...
              <div>
                ...
                <select className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-lg font-medium text-slate-800">
                  <option>Caterpillar 6040 FS (Mining Shovel)</option>
                  <option>Komatsu PC8000-11</option>
                  <option>Liebherr R 9800 G6</option>
                </select>
              </div>
              ...
              <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200 space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <input 
                    ...
                    className="flex-1 p-2 bg-white border border-slate-200 rounded text-[11px] font-mono text-slate-800"
                  />
            ...
            <div className="flex items-center justify-end gap-3 border-t border-slate-100 pt-4">
              <button 
                onClick={() => setShowModal(false)}
                className="px-4 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold rounded-lg text-xs font-mono transition cursor-pointer"
              >
                Cancel
              </button>
              <button 
                onClick={() => setShowModal(false)}
                className="px-5 py-2 bg-[#E65100] hover:bg-[#D84315] text-white font-bold rounded-lg text-xs font-mono shadow-sm transition cursor-pointer"
              >
